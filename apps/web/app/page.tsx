  ...
  useEffect(() => {
    ...
    if (storedUser) {
      try {
        ...
        console.log('🔍 Checking existing user:', { username: userData.username, onboarded: userData.onboarded });

        // If user exists and has completed onboarding, go to oracle
        if (userData.onboarded === true) {
          console.log('✅ Returning user detected - redirecting to /oracle');
          router.push('/oracle');
        } else {
      ...
      <section className="relative py-24 px-4 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center space-y-6">
          ...
          <div className="grid grid-cols-5 gap-4 mt-12 max-w-3xl mx-auto">
            ...
            <div className="text-center space-y-2">
              <div className="w-16 h-16 mx-auto bg-ain-soph-blue/20 rounded-full flex items-center justify-center">
                <span className="text-2xl">✨</span>
              </div>
