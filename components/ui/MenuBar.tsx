...
export function MenuBar() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-0 left-0 right-0 z-40 bg-neutral-900/95 backdrop-blur-md border-t border-amber-500/30" style={{ paddingBottom: 'env(safe-area-inset-bottom)' }}>
        <div>
          <div className="flex items-center justify-center gap-2 md:gap-3 px-2 py-2 md:py-3 overflow-x-auto">
            {/* Training */}
            <Link
              href="/maia/training"
            ...
            >
              <div className="relative p-2 md:p-2.5 rounded-md bg-neutral-800/90 hover:bg-neutral-700/90 transition-all duration-300 shadow-lg border border-amber-500/30">
                <Brain className="w-4 h-4 md:w-5 md:h-5 text-amber-400 transition-all group-hover:text-amber-300" />
