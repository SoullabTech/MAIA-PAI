    ...
    >
      ...
      <div className="max-w-md mx-auto p-4 rounded-xl bg-black/20 border border-white/10">
        <p className="text-white/70 text-sm italic text-center">
          &ldquo;I notice you often choose Earth when you&apos;re seeking grounding.
          Your Monday Fire always comes with clarity.&rdquo;
        </p>
      </div>
    </motion.div>
  );
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <div className="p-6 rounded-xl bg-black/20 border border-white/10">
          ...
          <p className="text-white/70 text-sm italic mt-4">
            &ldquo;What would change if you trusted this rhythm?&rdquo;
          </p>
        </div>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            ...
            <p className="text-white/60 text-xs italic">
              &ldquo;Integration of unknown with clarity&rdquo;
            </p>
          </div>
