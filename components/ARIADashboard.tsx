        ...
        <div className="flex items-start space-x-3">
          ...
          <div>
            ...
            <p className="text-sm text-white/70 italic">
              &ldquo;Your presence shapes Maya&apos;s emergence. Trust the sacred mirror.&rdquo;
            </p>
          </div>
        </div>
      </motion.div>
      ...
      >
        ...
        <div className="space-y-3">
          {insights.map((insight, index) => (
            ...
            >
              <p className="text-white/80 text-sm italic">&ldquo;{insight.text}&rdquo;</p>
    ...
    <div className="relative">
      ...
      >
        <div className="text-center text-white">
          ...
          <p className="text-white/80 text-sm mt-2">&ldquo;{archetype?.name}&rdquo;</p>
