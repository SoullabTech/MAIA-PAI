...
export const OracleConversation: React.FC<OracleConversationProps> = ({
  ...
  const [conversationMode, setConversationMode] = useState<'voice' | 'chat'>('voice');
  ...
  return (
    <div className="oracle-conversation min-h-screen bg-[#1a1f2e] overflow-hidden">
      {/* iOS Audio Enable Button - Shows when needed */}
      ...
      {/* Redesigned Bottom Icon Bar - Sacred Style - Hidden in chat mode to avoid overlap */}
      {!showChatInterface && (
