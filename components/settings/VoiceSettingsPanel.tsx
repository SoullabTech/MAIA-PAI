...
export default function VoiceSettingsPanel({ isOpen, onClose }: VoiceSettingsPanelProps) {
  ...
  let toggleAdaptiveMode: any;
  let error: string | null = null;

  try {
    const context = useVoiceSettings();
    settings = context.settings;
    updateSettings = context.updateSettings;
    toggleAdaptiveMode = context.toggleAdaptiveMode;
    error = context.error;
  } catch (err) {
    console.error('VoiceSettings context error:', err);
    ...
    updateSettings = () => console.warn('Settings update not available');
    toggleAdaptiveMode = () => console.warn('Toggle not available');
    error = 'Voice settings temporarily unavailable';
  }
