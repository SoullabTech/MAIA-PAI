...
export default function QuickFeedback({ onClose, autoShow = false }: QuickFeedbackProps) {
  ...
  if (isSubmitted) {
    return (
      <div className="fixed bottom-32 right-4 z-50 bg-[#1A1F2E] border border-sacred-gold/20 rounded-lg p-4 shadow-lg max-w-sm">
  ...
  return (
    <div className="fixed bottom-32 right-4 z-50 bg-[#1A1F2E] border border-gray-700 rounded-lg shadow-lg max-w-sm">
      <div className="p-4">
