    ...
    <div className="min-h-screen bg-[#1a1f2e] p-8">
      <div className="max-w-7xl mx-auto">
        ...
        >
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="px-4 py-2 bg-ain-soph-blue/50 border border-ain-soph-gold/30 text-ain-soph-amber
                       rounded-lg hover:bg-ain-soph-gold/30 transition-all"
            >
        ...
        {showSoulprint && (
          ...
          >
            {/* User Selector */}
            <div className="mb-6 p-4 bg-black/40 rounded-lg border border-ain-soph-gold/20">
              <label className="text-sm text-ain-soph-amber mb-2 block">Select User</label>
              <input
                type="text"
                ...
                className="w-full px-4 py-2 bg-black/40 border border-white/10 rounded-lg
                         text-white placeholder-white/40 focus:border-ain-soph-gold/50
                         focus:outline-none"
              />
        ...
        {metrics && (
          <>
            ...
            <motion.div
              ...
              className="mb-6 p-6 bg-black/40 backdrop-blur-sm rounded-lg border border-ain-soph-gold/20"
            >
