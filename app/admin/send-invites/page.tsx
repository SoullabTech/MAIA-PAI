    ...
    try {
      ...
      const invites = lines
        ...
        .map(line => {
          ...
          const name = parts[0];
          const email = parts[1];
          const betaCode = parts[2]; // Third column is beta code
          return { name, email, betaCode };
        })
      ...
      <div className="max-w-4xl mx-auto">
        ...
        <Card className="bg-[#1a1f3a] border-amber-500/20 p-6 mb-8">
          ...
          >
            ...
            <option value="beta-day2-update">🌀 Day 2: Community Hub & Updates</option>
            <option value="beta-week1-checkin">📅 Week 1 Check-in</option>
            <option value="beta-week2-celebration">🌀 Week 2: MAIA's Evolution</option>
          ...
          <p className="text-xs text-amber-200/40 mt-2">
            ...
            {template === 'beta-day2-update' && 'Day 2: Community Hub, Discord/Telegram, Lab Notes & Beta Monitoring'}
            {template === 'beta-week1-checkin' && 'First week experience check-in'}
            {template === 'beta-week2-celebration' && 'Week 2: Alchemical transformation story & new cognitive engines activate'}
          ...
          <Card className="bg-[#1a1f3a] border-amber-500/20 p-6">
            ...
            <div className="mb-6">
              ...
              <p className="text-xs text-amber-200/40 mb-3">
                Format: Name, email@example.com, BETA-CODE (optional)
              </p>
              <textarea
                value={csvText}
                onChange={(e) => setCsvText(e.target.value)}
                placeholder="Kelly, kelly@example.com, SOULLAB-KELLY&#10;Sarah, sarah@example.com, SOULLAB-SARAH&#10;Michael, michael@example.com, SOULLAB-MICHAEL"
                rows={10}
