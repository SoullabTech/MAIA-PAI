  ...
  return (
    <div className="min-h-screen bg-[#1a1f3a] px-4 py-8">
      ...
      <div className="relative z-10 max-w-7xl mx-auto">
        ...
        {/* Coming soon section */}
        <div className="mt-8 bg-gradient-to-r from-purple-500/5 to-amber-500/5 border border-ain-soph-gold/20 rounded-xl p-6">
          <div className="flex items-start gap-3">
            <Sparkles className="w-5 h-5 text-ain-soph-amber mt-0.5 flex-shrink-0" />
            <div>
