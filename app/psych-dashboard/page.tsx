      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2 px-4 py-2 bg-ain-soph-blue/50 border border-ain-soph-gold/30 rounded-lg">
              <Shield className="w-4 h-4 text-ain-soph-amber" />
              <span className="text-sm text-ain-soph-amber">HIPAA Compliant</span>
            </div>
          </div>
        </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 bg-ain-soph-blue/50 border border-ain-soph-gold/30 text-ain-soph-amber rounded-lg hover:bg-ain-soph-gold/30 transition-all"
        ...
        {/* HIPAA Notice */}
        <div className="mt-6 p-4 bg-ain-soph-blue/20 border border-ain-soph-gold/20 rounded-lg">
          <div className="flex items-start gap-2">
            <Shield className="w-5 h-5 text-ain-soph-amber flex-shrink-0 mt-0.5" />
            <div className="text-sm text-ain-soph-amber">
...
function StatCard({ icon, label, value, color }: any) {
  const colors = {
    ...
    purple: 'border-ain-soph-gold/30 bg-ain-soph-gold/5 text-ain-soph-amber',
...
function getPhaseColor(phase: string): string {
  const colors: Record<string, string> = {
    ...
    descent: 'bg-ain-soph-blue/50 text-ain-soph-amber border border-ain-soph-gold/30',
