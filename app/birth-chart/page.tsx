      ...
      <div className="relative z-10 min-h-screen flex items-center justify-center px-4 py-12">
        <div className="w-full max-w-2xl">
          ...
          >
            ...
            <p className="text-amber-300/60 text-lg max-w-xl mx-auto">
          ...
          <motion.div
            ...
            className="bg-gradient-to-br from-stone-900/80 via-amber-950/40 to-stone-900/80 backdrop-blur-xl border border-amber-900/30 rounded-2xl p-8 shadow-2xl"
          >
            {/* Date Step */}
            {step === 'date' && (
              <motion.div
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-amber-400/60 text-sm">When did you enter this world?</p>
                  </div>
                </div>
                ...
                <input
                  ...
                  className="w-full px-4 py-4 bg-black/40 border border-amber-800/50 rounded-lg text-amber-100 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all"
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-amber-400/60 text-sm">Precision matters for house positions</p>
                  </div>
                </div>
                ...
                <p className="text-amber-500/40 text-xs mt-3">
              ...
              >
                <div className="flex items-center gap-3 mb-6">
                  ...
                  <div>
                    ...
                    <p className="text-amber-400/60 text-sm">Where on Earth were you born?</p>
                  </div>
                </div>
                ...
                {!formData.location ? (
                  <>
                    <input
                      ...
                      className="w-full px-4 py-4 bg-black/40 border border-amber-800/50 rounded-lg text-amber-100 placeholder-amber-600/40 focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all"
                    />

                    {isSearching && (
                      <div className="mt-4 text-center text-amber-500/60 text-sm flex items-center justify-center gap-2">
                      ...
                      <div className="mt-4 space-y-2 max-h-64 overflow-y-auto">
                        {locationResults.map((loc, i) => (
                          <button
                            ...
                            className="w-full text-left px-4 py-3 bg-black/60 hover:bg-amber-900/20 border border-amber-900/30 hover:border-amber-700/50 rounded-lg text-amber-200 text-sm transition-all"
                          >
            ...
            {step === 'processing' && (
              ...
              >
                <div className="inline-block p-4 bg-amber-900/30 rounded-full mb-6">
            ...
            {error && step !== 'processing' && (
              <div className="mt-6 px-4 py-3 bg-red-950/30 border border-red-900/50 rounded-lg">
            ...
            {/* Navigation */}
            {step !== 'processing' && (
              <div className="flex items-center justify-between mt-8 pt-6 border-t border-amber-900/30">
                {step !== 'date' ? (
                  <button
                    onClick={() => {
                  ...
                  <Link
                    href="/astrology"
                    className="text-amber-600 hover:text-amber-500 transition-colors text-sm"
                  >
                    Cancel
                  </Link>
                )}
