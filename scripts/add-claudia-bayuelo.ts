...
async function addClaudiaBayuelo() {
  console.log('Adding Claudia Bayuelo to beta testers...');

  const email = 'claudia.bayuelo@studiolabs.com';
  const explorerName = 'Claudia';
  const invitationCode = 'SOULLAB-CLAUDIA';
  ...
  try {
    ...
    if (existingExplorer) {
      ...
      console.log('Claudia Bayuelo added to beta testers!');
      console.log('Explorer ID:', data[0].explorer_id);
      console.log('Explorer Name:', data[0].explorer_name);
      console.log('Invitation Code:', invitationCode);
      console.log('Claudia can now sign up with passcode: SOULLAB-CLAUDIA');
    }
