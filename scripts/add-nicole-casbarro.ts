...
async function addNicoleCasbarro() {
  console.log('Adding Nicole Casbarro to beta testers...');

  const email = 'nicolecasbarro@gmail.com';
  const explorerName = 'Nicole';
  const invitationCode = 'SOULLAB-NICOLE';
  ...
  try {
    ...
    if (existingExplorer) {
      ...
      console.log('Nicole Casbarro added to beta testers!');
      console.log('Explorer ID:', data[0].explorer_id);
      console.log('Explorer Name:', data[0].explorer_name);
      console.log('Invitation Code:', invitationCode);
      console.log('Nicole can now sign up with passcode: SOULLAB-NICOLE');
    }
