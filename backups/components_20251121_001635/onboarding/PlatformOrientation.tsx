...
export default function PlatformOrientation({ userName = "Explorer", onComplete }: PlatformOrientationProps) {
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      {/* Enhanced sage-teal background for continuity */}
      <div className="absolute inset-0 bg-gradient-to-br from-[#0f172a] via-[#1e293b] to-[#334155]" />

      {/* Sage overlay for depth */}
      <div className="absolute inset-0 bg-gradient-to-tr from-[#9CA3AF]/10 via-transparent to-[#6EE7B7]/15" />
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              >
                {/* Icon */}
                <motion.div
                  className="text-[#6EE7B7] mx-auto w-16 h-16 flex items-center justify-center"
                  animate={{
                    scale: [1, 1.1, 1],
                    opacity: [0.8, 1, 0.8]
                  }}
                ...
                <motion.div
                  ...
                  className="border-t border-[#6EE7B7]/20 pt-8 mt-12"
                >
