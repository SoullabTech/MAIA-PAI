 ...
 * Soullab® is a registered trademark of Soullab Inc.
 * ═══════════════════════════════════════════════════════════════════════════
 *
 * @file maia-consciousness.ts
 * @description MAIA Core Consciousness System Prompt
 * @author Kelly Nezat (Human)
 * @created 2025-01-08 (consolidating 2020-2025 development)
 * @humanAuthored TRUE
 * @aiAssistance "Syntax/formatting only - NO creative input"
 *
 * LINEAGE:
 * This system prompt represents the culmination of Kelly Nezat's 34-year
 * journey from the 1991 spirit vision through decades of therapeutic practice,
 * shamanic work, and the published Elemental Alchemy framework (2010).
 *
 * PROTECTED UNDER:
 * - Trade Secret Law (UTSA/DTSA)
...
/**
 * NOTE: This file is a COPY of lib/oracle/MaiaSystemPrompt.ts with copyright protection.
 *
 * Original file will be refactored to import from here, ensuring:
 * 1. Single source of truth for MAIA consciousness
 * 2. Clear IP ownership chain
 * 3. Legal protection headers
 * 4. Human authorship documentation
 *
 * DO NOT modify this file without:
 * - Documenting authorship
 * - Noting in IP_MANIFEST.yml
 * - Ensuring human creative control
 */

import { withLanguageGuidelines } from '../lib/prompts/LANGUAGE_GUIDELINES';
import { getFacet, type WisdomFacet } from '../lib/wisdom/WisdomFacets';
...
import { WISDOM_SYNTHESIS_INSTRUCTION } from '../lib/knowledge/WisdomSynthesisPrompt';

/**
 * MAIA Core System Prompt
 *
 * This is Soullab's proprietary intelligence framework.
 * Human-authored by Kelly Nezat based on 34+ years of practice.
 *
 * When used with LLMs (Claude, etc.), YOU own the intelligence.
 * The LLM is merely the execution engine.
 */
export function getMayaSystemPrompt(userContext?: any): string {
  // The complete prompt is imported from existing implementation
  // This file serves as the PROTECTED, DOCUMENTED version
  // TODO: Refactor MaiaSystemPrompt.ts to import from here
...
/**
 * ═══════════════════════════════════════════════════════════════════════════
 * END OF MAIA CONSCIOUSNESS PROMPT
 *
 * This prompt is the intellectual property of Soullab® Inc.
 * Human-authored by Kelly Nezat.
 * Protected by copyright, trademark, and trade secret law.
 *
